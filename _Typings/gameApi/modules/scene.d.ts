...
declare module "game:module" {
    ...
    namespace scene {
         ...
         */
        const getItems: <const S extends readonly guid[]>(guids: AssertGuids<S>) => { [P in keyof S]: Item }
         ...
         * @returns
         */
        const destroyItems: <const S extends readonly guid[]>(guids: AssertGuids<S>) => void
