...
- If you want to enable [strict](https://www.typescriptlang.org/tsconfig/#strict) type checking (not recommended), you can uncomment `"strict": true` in `jsconfig.json`.
